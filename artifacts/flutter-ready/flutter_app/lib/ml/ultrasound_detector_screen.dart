...
class UltrasoundDetectorScreen extends StatefulWidget {
  ...
  @override
  State<UltrasoundDetectorScreen> createState() =>
      _UltrasoundDetectorScreenState();
}
...
class _UltrasoundDetectorScreenState extends State<UltrasoundDetectorScreen> {
  ...
  void initState() {
    super.initState();
    _service = YoloDetectorService(
        inputSize: 640, confThreshold: 0.25, iouThreshold: 0.45);
    _initModel();
  }
      ...
      children: [
        Expanded(
          child: ElevatedButton.icon(
            onPressed:
                disabled ? null : () => _pickAndDetect(ImageSource.gallery),
        ...
        Expanded(
          child: OutlinedButton.icon(
            onPressed:
                disabled ? null : () => _pickAndDetect(ImageSource.camera),
